...
const treatments: Record<Client["treatment"], string> = {
  bold: "font-sans text-lg font-black tracking-tight sm:text-xl",
  serif: "font-heading text-lg font-bold sm:text-xl",
  wide: "font-sans text-sm font-semibold tracking-[0.2em] sm:text-base",
  mono: "font-mono text-base font-semibold tracking-tight sm:text-lg",
};
    ...
    <section className="bg-primary py-14 sm:py-16">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <h2 className="font-heading text-2xl font-normal text-lime sm:text-3xl">
      ...
      <ul
        ref={railRef}
        className="no-scrollbar rail-gutter mt-8 flex snap-x snap-mandatory gap-4 overflow-x-auto scroll-smooth pb-1"
      >
        {clients.map((client) => (
          <li key={client.name} className="w-40 shrink-0 snap-start sm:w-48">
            <div className="grid aspect-3/2 place-items-center rounded-bl-[1.75rem] bg-white px-4 text-center">
              <span
